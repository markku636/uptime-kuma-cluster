 ...
 * /api/entry-page:
 *   get:
 *     summary: Get entry page configuration
 *     tags: [General]
 *     responses:
 *       200:
 *         description: Entry page configuration
 *         content:
 *           application/json:
 *             schema:
 *               type: object
 ...
 *                 type:
 *                   type: string
 *                   enum: [entryPage, statusPageMatchedDomain]
 *                 entryPage:
 *                   type: string
 *                 statusPageSlug:
 *                   type: string
 ...
 * /api/push/{pushToken}:
 *   get:
 *     summary: Push monitor status update
 *     tags: [Push]
 *     parameters:
 *       - in: path
 *         name: pushToken
 ...
 *         schema:
 *           type: string
 *         description: Push monitor token
 *       - in: query
 *         name: status
 *         schema:
 *           type: string
 ...
 *     responses:
 *       200:
 *         description: Push received successfully
 *         content:
 *           application/json:
 *             schema:
 *               type: object
 ...
 *                   example: true
 *       404:
 *         description: Monitor not found or inactive
 *         content:
 *           application/json:
 *             schema:
 *               type: object
 ...
 *                   type: string
 *   post:
 *     summary: Push monitor status update (POST)
 *     tags: [Push]
 *     parameters:
 *       - in: path
 *         name: pushToken
 ...
 * /api/badge/{id}/status:
 *   get:
 *     summary: Get status badge for monitor
 *     tags: [Badges]
 *     parameters:
 *       - in: path
 *         name: id
 ...
 *           type: string
 *           default: Up
 *         description: Label when status is up
 *       - in: query
 *         name: downLabel
 *         schema:
 *           type: string
 *           default: Down
 *         description: Label when status is down
 *       - in: query
 *         name: pendingLabel
 *         schema:
 *           type: string
 *           default: Pending
 *         description: Label when status is pending
 *       - in: query
 *         name: maintenanceLabel
 *         schema:
 *           type: string
 *           default: Maintenance
 *         description: Label when in maintenance
 *       - in: query
 *         name: style
 *         schema:
 *           type: string
